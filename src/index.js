...
async function admin(request, env, url) {
  ...
  if (request.method === 'GET') {
    ...
    if (path === 'status') {
      ...
      return json({ version: VERSION, bot: me.username, automaticPermanentBan: false, pendingUpdates: webhook.pending_update_count, lastWebhookErrorAt: webhook.last_error_date || null, webhookConfigured: !!webhook.url, permissions });
    }
  }
