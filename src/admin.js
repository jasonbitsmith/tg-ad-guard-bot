...
<style>body{font:15px/1.6 system-ui;background:#10151e;color:#e7edf5;max-width:1050px;margin:auto;padding:28px}h1{font-size:24px}input,select,button,textarea{font:inherit;padding:8px 12px;margin:5px;border-radius:8px;border:1px solid #46536b;background:#1b2638;color:inherit}textarea{display:block;width:min(100%,700px);min-height:72px}button{cursor:pointer}article{background:#1b2638;border-radius:12px;padding:16px;margin:12px 0;overflow-wrap:anywhere}small,.muted{color:#abb8cd}#error{color:#ffb19e;white-space:pre-wrap}pre{white-space:pre-wrap}.chip{display:inline-block;border:1px solid #46536b;padding:4px;margin:3px;border-radius:8px}.hidden{display:none}label{display:inline-block}button:disabled{opacity:.4}a{color:#9cbeff}</style></head>
